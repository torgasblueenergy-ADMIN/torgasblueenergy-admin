        ...
        <div className="grid md:grid-cols-4 gap-10 pb-12 border-b border-slate-800">
          ...
          <div>
            ...
            <div className="space-y-4">
              {/* WhatsApp */}
              <a href="https://wa.me/6285111044226" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                ...
                <span className="text-sm font-medium">+62 851-1104-4226</span>
              </a>
