            ...
            <div className="lg:col-span-8 flex flex-col">
              ...
              <div className="w-full h-[520px] sm:h-[620px] rounded-2xl overflow-hidden border border-slate-300 bg-slate-100 shadow-inner">
                {member.cvPdf ? (
                  ...
                  /* Fallback: CV not available yet — tampilkan pesan, bukan iframe kosong */
                  <div className="w-full h-full flex flex-col items-center justify-center text-center px-8 gap-3">
                    ...
                    <p className="text-sm font-extrabold text-[#041b2e]">CV not available yet</p>
                    <p className="text-xs text-slate-500 max-w-xs">
                      The CV for {member.name} is still being uploaded. Please contact us for more information.
                    </p>
                  </div>
                )}
              </div>
